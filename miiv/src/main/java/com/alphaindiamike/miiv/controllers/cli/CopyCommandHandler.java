...
public class CopyCommandHandler implements CommandHandler{
	...
	@Autowired
	public CopyCommandHandler(GlobalSettingsService settingsService, ConfigurationLoaderService configurationLoader,
    ...
    public CommandResponse supports(String command) {
		if (command.equals("copy") && (settingsService.getSetting("workspace_dir") == null)) {
